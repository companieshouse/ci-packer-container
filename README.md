...
----------------------- | -------------------------------------------------------------------- | ------------
packer_version          | Packer version installed on the container                            | 1.15.0
ansible_version         | Ansible version installed on the container                           | 13.7.0
...
```
packer-1.15.0-ansible-13.7.0-container-<CONTAINER_VERSION>
```
